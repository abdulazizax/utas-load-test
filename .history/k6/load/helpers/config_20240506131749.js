...
// Import ommiy hamma modullar
// import { open } from 'k6';

// // ID raqamlarini saqlash uchun fayl nomi
// const fileId = 'user_ids.txt';

// // Faylni ochish va yozish funksiyasi
// export function writeUserIdsToFile(id) {
//   const file = open(fileId, 'a');
//   file.write(id + '\n');
//   file.close();
// }
